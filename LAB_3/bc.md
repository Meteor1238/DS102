...
| Mô hình | Precision | Recall | F1-Score | Thời gian train |
| :--- | :---: | :---: | :---: | :---: |
| **SVM (SGD)** | **0.7665** | 0.9846 | 0.8620 | 51.75 giây |
| **SVM (Sklearn `LinearSVC`)** | 0.7274 | 0.9923 | 0.8395 | 147.11 giây |
...
![Loss](img/loss.png)
*(Quá trình hội tụ sau 50 Epochs)*
